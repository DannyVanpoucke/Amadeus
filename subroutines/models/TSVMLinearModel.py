# -*- coding: utf-8 -*-
"""
Created on Thu Nov 14 10:17:47 2019

The Linear SVM class.
...
class TSVMLinearModel(TSVMClass):
    """
    Child class of the SVM-class representing a specific type(kernel) of SVM : Linear SVM
    """
    def __init__(self,name,Target, Feature: pd.DataFrame, 
        ...
        self.nameModel='Linear SVM Model'
        self.name=name
        ...
        self.model=SVR(kernel='linear',max_iter=self.max_iter) #we need a temporary starting model for the grid search...here we need to set all parameters except C and epsilon
    ...
    def setCoefficients(self):
        ...
        self.modelcoef['coef_']=[self.coefindex+1,np.matrix(self.model.coef_)]
